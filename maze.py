...
class Player(GameSprite):
    def update(self):
        ...
        if keys[K_RIGHT]  and self.rect.x > -80:
            self.rect.x += self.speed
...
class Emeny(GameSprite):
    ...
    def update(self):
        if self.rect.x <= 470:
            self.direction = 'ridht'
        if self.rect.x > win_h - 85:
            self.direction = 'left'
...
hero = Player('hero.png', 5, 400, 4)
cyborg = Emeny('cyborg.png', win_r - 80, 280, 2 )
treasure = GameSprite('treasure.png', 580, 20 , 0)
wall_1 = Wall(255, 0, 0, 270, 0, 10 , 400)
wall_2 = Wall(255, 0, 0, 370, 200, 10, 400)
wall_3 = Wall(255, 0, 0, 470, 0, 10 , 400)
